...
@RoutePage()
class BASSSSKeytt extends StatefulWidget {
  const BASSSSKeytt({super.key});

  @override
  State<BASSSSKeytt> createState() => _BASSSSKeyttState();
}

class _BASSSSKeyttState extends State<BASSSSKeytt> {
        ...
        bottomNavigationBar: ValueListenableBuilder(
          ...
          builder: (context, _, __) => Row(
            ...
            children: [
              ...
              IconButton(
                icon: Icon(
                  PhosphorIconsBold.scribbleLoop,
  ...
  static IconData getShapeIcon(ShapeFactory? shapeFactory) {
    if (shapeFactory is LineFactory) return PhosphorIconsBold.lineSegment;
    if (shapeFactory is ArrowFactory) return PhosphorIconsBold.arrowUpRight;
    if (shapeFactory is DoubleArrowFactory) {
      return PhosphorIconsBold.arrowsHorizontal;
    }
    if (shapeFactory is RectangleFactory) return PhosphorIconsBold.rectangle;
    if (shapeFactory is OvalFactory) return PhosphorIconsBold.circle;
    return PhosphorIconsBold.polygon;
  }
